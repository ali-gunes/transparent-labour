...
export default function UserBadge({ voteCount, role }: BadgeProps) {
  ...
  if (role === 'ADMIN') {
    return (
      <span className="inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-medium bg-gradient-to-r from-purple-600 to-blue-500 text-white border border-purple-400 shadow-sm hover:shadow-md transition-shadow duration-200">

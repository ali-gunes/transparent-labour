      ...
      <div className="min-h-screen p-4 md:p-8">
        ...
        <section className="text-center py-16 bg-gradient-to-b from-blue-50 to-white dark:from-gray-900 dark:to-gray-800 rounded-3xl mb-12">
          ...
          <div className="space-y-6">
            <h3 className="text-2xl font-semibold text-gray-700 dark:text-gray-300">Kullanıcılarımızın Toplam Katkıları</h3>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg">
              <div className="text-center">
                ...
                <div className="text-sm text-gray-600 dark:text-gray-400">Maaş Verisi</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-blue-600 dark:text-blue-400 mb-2">
                  {stats.totalCompanies.toLocaleString()}
                </div>
                <div className="text-sm text-gray-600 dark:text-gray-400">Şirket</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-blue-600 dark:text-blue-400 mb-2">
                  {stats.totalPositions.toLocaleString()}
                </div>
                <div className="text-sm text-gray-600 dark:text-gray-400">Pozisyon</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-blue-600 dark:text-blue-400 mb-2">
                  {stats.totalLocations.toLocaleString()}
                </div>
                <div className="text-sm text-gray-600 dark:text-gray-400">Lokasyon</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="max-w-6xl mx-auto mt-16 px-4">
          <h2 className="text-3xl font-bold text-center mb-12">{tr.home.whyWeDoIt}</h2>
        ...
        <section className="max-w-6xl mx-auto mt-16 px-4">
          <h2 className="text-3xl font-bold text-center mb-12">{tr.home.ourGoals}</h2>
        ...
        <section className="max-w-6xl mx-auto mt-16 px-4 mb-16">
          <h2 className="text-3xl font-bold text-center mb-12">{tr.home.faq}</h2>

export const tr = {
  ...
  auth: {
    ...
    verify: {
      ...
      checkEmailDesc: 'Sizin gerçek bir kişi olduğunuzu doğrulamak ve platformdaki veri güvenliğini sağlamak için mail adresinizi doğrulamanızı rica ediyoruz.',
      mailSent: 'Doğrulama bağlantısı {email} adresinize gönderildi. Lütfen email adresinizi kontrol ediniz.',

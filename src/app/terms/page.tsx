  ...
  return (
    <article className="container mx-auto px-4 py-8">
      <div className="prose prose-lg dark:prose-invert mx-auto">
        <h1 className="text-3xl font-bold mb-6 text-gray-800 dark:text-white">Kullanım Koşulları</h1>
        
        <p className="text-gray-700 dark:text-gray-400 mb-8">Son güncellenme: 25 Şubat 2025</p>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">1. Hizmetin Kapsamı</h2>
          <p className="mb-4 text-gray-700 dark:text-gray-300">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">2. Kullanıcı Hesabı ve Güvenliği</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">3. Kullanıcı İçeriği ve Sorumluluklar</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">4. Verilerin Kullanımı ve Gizlilik</h2>
          <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">5. Hizmetin Kullanılabilirliği ve Sınırlamaları</h2>
          <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">6. Hizmet Şartlarında Değişiklikler</h2>
          <p className="mb-4 text-gray-700 dark:text-gray-300">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">7. İletişim</h2>
          <p className="mb-4 text-gray-700 dark:text-gray-300">

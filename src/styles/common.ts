export const commonStyles = {
  ...
  // Typography
  pageTitle: "text-2xl font-bold mb-6 text-gray-800 dark:text-white",
  text: "text-gray-800 dark:text-white",
  textMuted: "text-gray-700 dark:text-gray-300",
  textSmall: "text-sm text-gray-700 dark:text-gray-400",
  
  // Cards
  card: "bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 transition-colors",
  cardHeader: "border-b border-gray-100 dark:border-gray-700 p-6",
  cardBody: "p-6",
  
  // Forms
  formContainer: "max-w-md mx-auto",
  formCard: "bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 transition-colors",
  formBody: "p-6 space-y-4",
  label: "block mb-2 text-gray-800 dark:text-white font-medium",
  input: `
    w-full p-2 bg-white dark:bg-gray-800 
